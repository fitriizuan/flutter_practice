...
class ValidList extends StatefulWidget {
  @override
  _ValidListState createState() => _ValidListState();
}

class _ValidListState extends State<ValidList>
    with AutomaticKeepAliveClientMixin<ValidList> {
  ...
  Widget build(BuildContext context) {
    ...
    return GoogleTranslatorInit(apiKey,
        ...
        builder: () => Scaffold(
            appBar: AppBar(
              title: const Text('Senarai Ayat Yang Betul'),
              ...
              actions: <Widget>[
                IconButton(
                  ...
                  tooltip: "Padam Senarai Ayat Yang Betul",
                  color: Colors.red,
                  iconSize: 40,
                ),
              ],
  ...
  Widget _homeBody() {
    if (_myRndmWordService.myValidSet.isNotEmpty) {
      return _hasData();
    } else {
      return _noData();
    }
      ...
      builder: (context) => Center(
        child: Column(
          ...
          children: const [
            ...
            Text(
              'Tiada Lagi Senarai Bagi Ayat Yang Betul',
              style: TextStyle(
                fontSize: 20,
                fontWeight: FontWeight.bold,
              ),
            ...
            Padding(padding: EdgeInsets.symmetric(vertical: 10)),
            Text(
              'Sila Pilih Dari Semua Senarai Ayat untuk dimasukkan ke Senarai Ayat Yang Betul',
              style: TextStyle(
                fontSize: 20,
                fontWeight: FontWeight.bold,
              ),
  ...
  Widget _hasData() {
    return ListView.builder(
      ...
      itemCount: _myRndmWordService.myValidSet.length,
